...
class OidcClientNameResolutionTest {
    ...
    void clientName_generates_composite_name() {
        Workflow workflow = FlowWorkflowBuilder.workflow("orders", "acme", "1.0.0").build();
    ...
    void clientName_handles_default_namespace() {
        Workflow workflow = FlowWorkflowBuilder.workflow("orders").build();
    ...
    void clientName_uses_workflow_definition_id() {
        Workflow workflow = FlowWorkflowBuilder.workflow("inventory", "contoso", "3.5.1").build();
