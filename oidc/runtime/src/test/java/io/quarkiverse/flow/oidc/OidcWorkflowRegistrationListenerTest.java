...
class OidcWorkflowRegistrationListenerTest {

    private OidcWorkflowRegistrationListener listener;
    ...
    void setUp() {
        ...
        listener = new OidcWorkflowRegistrationListener();
    ...
    void named_policy_no_override_uses_policy_name() {
        ...
        // When
        listener.onWorkflowRegistered(new WorkflowDescriptorRegisteredEvent(workflow));
    ...
    void user_configured_client_exists_skips_creation() {
        ...
        verify(registry, times(1)).register(eq("keycloak"), eq(existingClient), any(TokenAuthPolicy.class));
    }
