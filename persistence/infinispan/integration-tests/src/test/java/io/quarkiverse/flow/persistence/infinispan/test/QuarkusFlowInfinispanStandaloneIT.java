...
@QuarkusTest
@QuarkusTestResource(value = InfinispanRespStandaloneResource.class, restrictToAnnotatedClass = true)
@DisabledOnOs(OS.WINDOWS)
public class QuarkusFlowInfinispanStandaloneIT extends AbstractHandlerPersistenceTest {
