...
public class FlowLangChain4jProcessorIT {
    ...
    void shouldCreateCompleteDefinition() {
        InstanceHandle<Agents.StoryCreatorWithConfigurableStyleEditor> creatorInstance = Arc.container()
                .instance(Agents.StoryCreatorWithConfigurableStyleEditor.class);
        assertThat(creatorInstance.isAvailable()).isTrue();

        Agents.StoryCreatorWithConfigurableStyleEditor writer = creatorInstance.get();
        String story = writer.write("dragons", "drama", "girls");
