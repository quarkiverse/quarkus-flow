...
import io.quarkiverse.flow.langchain4j.FlowLangChain4jApplicationBuilderCustomizer;
...
public class FlowLangChain4jProcessor {
    ...
    AdditionalBeanBuildItem registerRuntimeServices() {
        return AdditionalBeanBuildItem.builder()
                .addBeanClass(FlowLangChain4jApplicationBuilderCustomizer.class)
                .addBeanClass(FlowAgentsBuilderService.class)
                .addBeanClass(RuntimeWorkflowApplicationProvider.class)
                .setUnremovable()
                .build();
    }
