# Quarkus Quarkus Flow :: Durable :: Kubernetes

[![Version](https://img.shields.io/maven-central/v/io.quarkiverse.flow/quarkus-flow-durable-kubernetes?logo=apache-maven&style=flat-square)](https://central.sonatype.com/artifact/io.quarkiverse.flow/quarkus-flow-durable-kubernetes-parent)
