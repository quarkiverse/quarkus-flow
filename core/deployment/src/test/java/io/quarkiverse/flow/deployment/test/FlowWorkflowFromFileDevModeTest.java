...
public class FlowWorkflowFromFileDevModeTest {
    ...
    void should_reload_flow_identifier() {
        ...
        String oldIdentifier = "io.quarkiverse.flow.generated.default.WaitDurationInlineWorkflow";
        ...
        identifierMustMatch(path, "io.quarkiverse.flow.generated.default.WaitPleaseWorkflow");
