...
This guide shows you how to load and use Serverless Workflow definitions from YAML files in your Quarkus application, making them available as CDI beans for injection and execution.


== 1) Create the workflow specification file

Create a directory `src/main/flow` in your project and add a Serverless Workflow specification file:
