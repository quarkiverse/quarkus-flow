...
When active, every time a task is completed the current workflow information is written into Redis database. 
...
Add Quarkus Redis Flow dependency to your `pom.xml`
