...
=== Automatic Kafka configuration with DevServices

Instead of manually configuring every `mp.messaging.*` property, you can let Quarkus Flow set the full Kafka stack automatically in dev and test mode with a single flag:
