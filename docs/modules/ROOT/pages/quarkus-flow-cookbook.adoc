...
You can also override per-workflow or per-task with `quarkus.flow.grpc.client.<key>.name=<clientName>`.
...
See xref:grpc.adoc[the gRPC guide] for the Quarkus client configuration variant.
