...
When you enable xref:persistence.adoc[State Persistence], Quarkus Flow stores enough information in the database to resume paused or failed workflow executions.
