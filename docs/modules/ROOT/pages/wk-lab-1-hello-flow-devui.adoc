...
* Make sure the generated `GreetingResource` is removed or uses a different `@Path`, otherwise `/hello` will still return the default `"Hello from Quarkus REST"` response.
