...
[source,java]
----
include::{examples-dir-level1}org/acme/example/CustomerProfileFlow.java[]
----
...
[source,java]
----
include::{examples-dir-level1}org/acme/example/CustomerProfileResource.java[]
----
...
[source,java]
----
include::{examples-dir-level1}org/acme/example/PetstoreFlow.java[]
----
...
Next: xref:workshop/lab-3-events-yaml.adoc[Lab 3 – Events with YAML workflows].
