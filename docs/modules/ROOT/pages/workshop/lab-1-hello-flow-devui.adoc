...
[source,java]
----
include::{examples-dir-level1}org/acme/HelloWorkflow.java[]
----
...
[source,java]
----
include::{examples-dir-level1}org/acme/HelloResource.java[]
----
...
Next: xref:workshop/lab-2-http-openapi.adoc[Lab 2 – Call HTTP & OpenAPI services].
