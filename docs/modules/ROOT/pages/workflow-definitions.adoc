...
[TIP]
====
You can define a global namespace prefix for *Fully Qualified Class Name* identifiers using the xref:configuration.adoc#quarkus-flow_quarkus-flow-definitions-namespace-prefix[`quarkus.flow.definitions.namespace.prefix`] property in your `application.properties`.
====
