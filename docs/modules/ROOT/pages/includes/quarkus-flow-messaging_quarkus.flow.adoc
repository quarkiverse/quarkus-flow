...
a| [[quarkus-flow-messaging_quarkus-flow-messaging-enable-correlation-propagation]] [.property-path]##link:#quarkus-flow-messaging_quarkus-flow-messaging-enable-correlation-propagation[`quarkus.flow.messaging.enable-correlation-propagation`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.flow.messaging.enable-correlation-propagation+++[]
endif::add-copy-button-to-config-props[]
...
The default correlation metadata includes:
 ...
 - `flowinstanceid` - the Workflow instance's ID
 - `flowtaskid` - the task position where the event was published


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_FLOW_MESSAGING_ENABLE_CORRELATION_PROPAGATION+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_FLOW_MESSAGING_ENABLE_CORRELATION_PROPAGATION+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
